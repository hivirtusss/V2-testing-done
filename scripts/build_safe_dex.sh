...
# Virtus V3 — dark red/black UI (screenshot match), detailed V logo on bubble
sed -i \
  ...
  -e 's/const v8, -0xb4aa9d/const v8, -0x4d0000/g' \
  -e 's/const v1, -0xb4aa9d/const v1, -0x4d0000/g' \
  -e 's/const v2, -0xb4aa9d/const v2, -0x4d0000/g' \
  -e 's/const v24, -0xb4aa9d/const v24, -0x4d0000/g' \
  -e 's/const v17, -0xb4aa9d/const v17, -0x4d0000/g' \
